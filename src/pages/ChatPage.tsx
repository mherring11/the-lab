...
const ChatPage: React.FC = () => {
  ...
  return (
    <div className="flex h-[calc(100vh-64px)]">
      {/* Left sidebar with experts list */}
      <div className="w-[280px] bg-white border-r border-gray-200 flex flex-col">
        {/* Search and filter section */}
        <div className="p-4 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">Health Experts</h2>
          <p className="text-sm text-gray-500 mb-4">Chat with our specialists</p>
        ...
        <div className="flex-1 overflow-y-auto">
          {filteredExperts.map(expert => (
            <button
              key={expert.id}
              className={`w-full text-left p-3 border-b border-gray-100 flex items-center ${
            ...
            >
              ...
              {selectedExpert?.id === expert.id && (
                <span className="w-2 h-2 rounded-full bg-yellow-500 ml-auto"></span>
              )}
            </button>
          ))}
        </div>
      ...
      <div className="flex-1 bg-gray-50 relative">
        {selectedExpert ? (
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6">
            ...
            <h2 className="text-2xl font-semibold text-gray-800 mb-2">Select an Expert to Start Chatting</h2>
            <p className="text-gray-500 max-w-md">
              Our team of AI health and fitness specialists is ready to help you reach your goals.
              Choose an expert from the sidebar to begin.
            </p>
          </div>
        )}
      </div>
