...
export default function Footer() {
    return (_jsx("footer", { className: "bg-white pt-16 pb-8", children: _jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-12 mb-12", children: [_jsxs("div", { children: [_jsx("a", { href: "#top", "aria-label": "Go to homepage", children: _jsx(Logo, {}) }), _jsx("p", { className: "mt-4 text-gray-600", children: "Built in The Lab, Validated by Effort" })] }), _jsxs("div", { children: [_jsx("h3", { className: "text-lg font-bold text-gray-900 mb-4", children: "SERVICES" }), _jsx("ul", { className: "space-y-3", children: services.map(({ text, id }) => (_jsx("li", { children: _jsx("button", { onClick: () => scrollToSection(id), className: "text-gray-600 hover:text-primary focus:outline-none", children: text }) }, id))) })] }), _jsxs("div", { children: [_jsx("h3", { className: "text-lg font-bold text-gray-900 mb-4", children: "CONTACT US" }), _jsx("ul", { className: "space-y-3", children: contactInfo.map(({ icon: Icon, text, href }) => (_jsxs("li", { className: "flex items-center space-x-2", children: [_jsx(Icon, { className: "h-5 w-5 text-primary" }), _jsx("a", { href: href, className: "text-gray-600 hover:text-primary", children: text })] }, text))) })] })] }), _jsx("div", { className: "flex justify-center space-x-6 mb-8", children: socialLinks.map(({ icon, href, isCustom }) => (_jsx("a", { href: href, target: "_blank", rel: "noopener noreferrer", className: "transform transition-transform hover:scale-125 focus:outline-none", "aria-label": "Social Media Link", children: isCustom ? (_jsx("img", { src: icon, alt: "Threads Logo", className: "h-6 w-6" })) : (React.createElement(icon, { className: 'h-6 w-6 text-black' })) }, href))) }), _jsxs("div", { className: "border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center", children: [_jsxs("p", { className: "text-gray-500 text-sm", children: ["\u00A9 ", new Date().getFullYear(), " The Lab | All rights reserved"] }), _jsx("div", { className: "flex space-x-6 mt-4 md:mt-0", children: footerLinks.map(({ text, href }) => (_jsx("a", { href: href, className: "text-sm text-gray-500 hover:text-primary", children: text }, text))) })] })] }) }));
}
