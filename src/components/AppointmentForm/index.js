...
export default function AppointmentForm() {
    ...
    return (_jsx("section", { id: "appointment", className: "py-16 bg-gray-100", style: { scrollMarginTop: "6rem" }, children: _jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 lg:px-8", children: [_jsx("h2", { className: "text-4xl font-bold text-center mb-12 italic", children: "Start Your Fitness Journey" }), _jsxs("form", { onSubmit: handleSubmit, className: "bg-gray-200 p-8 rounded-lg", children: [_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [_jsx(FormInput, { label: "Your Full Name", type: "text", name: "fullName", required: true }), _jsx(FormInput, { label: "Best Email to Reach You", type: "email", name: "email", required: true }), _jsx(FormInput, { label: "Preferred Start Date", type: "date", name: "date", required: true }), _jsx(FormSelect, { label: "How Can We Help?", name: "service", options: serviceOptions, required: true })] }), _jsx(FormTextarea, { label: "Tell Us About Your Fitness Goals", name: "message", className: "mt-6", required: true }), _jsx("button", { type: "submit", className: `w-full mt-6 py-3 px-4 rounded font-medium transition-colors ${isSubmitting
                                ? "bg-gray-400 text-white cursor-not-allowed"
                                : "bg-black text-white hover:bg-gray-900"}`, disabled: isSubmitting, children: isSubmitting ? "Submitting..." : "Let’s Do This" })] }), status === "success" && (_jsx("p", { className: "text-green-600 text-center mt-4", children: "Your appointment request has been sent successfully!" })), status === "error" && (_jsx("p", { className: "text-red-600 text-center mt-4", children: "Something went wrong. Please try again." }))] }) }));
}
