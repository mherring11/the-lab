...
const PerformanceMetricsCard = () => {
    ...
    return (_jsx("div", { className: "bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden h-full", children: _jsxs("div", { className: "p-4", children: [_jsxs("div", { className: "flex justify-between items-center mb-5", children: [_jsx("h2", { className: "text-lg font-semibold text-gray-900", children: "Performance Metrics" }), _jsxs(Link, { to: "/metrics", className: "text-sm font-medium text-yellow-500 hover:text-yellow-600 flex items-center", children: ["View all", _jsx(ChevronRight, { className: "h-4 w-4 ml-1" })] })] }), _jsx("div", { className: "grid grid-cols-2 gap-3", children: metrics.map((metric) => {
                        ...
                        return (_jsxs("div", { className: "relative overflow-hidden rounded-xl border border-gray-100 p-4 bg-gradient-to-br from-white to-gray-50", children: [_jsx("div", { className: `absolute top-0 left-0 w-1.5 h-full ${colors.bg}` }), _jsxs("div", { className: "pl-2", children: [_jsx("h3", { className: "text-sm font-medium text-gray-700 mb-2 truncate pr-1", children: metric.name }), _jsxs("div", { className: "flex items-baseline mb-3", children: [_jsxs("span", { className: "text-2xl font-bold text-gray-900 mr-2", children: [metric.value, " ", _jsx("span", { className: "text-xs font-normal text-gray-500", children: metric.unit })] }), _jsxs("div", { className: `flex items-center text-xs font-medium ${isPositive ? 'text-green-600' : 'text-red-600'}`, children: [isPositive ? (_jsx(TrendingUp, { size: 12, className: "mr-0.5" })) : (_jsx(TrendingDown, { size: 12, className: "mr-0.5" })), changePercent, "%"] })] }), _jsxs("div", { className: "flex items-center", children: [_jsx("div", { className: "flex-grow", children: _jsx("div", { className: "h-1.5 w-full bg-gray-200 rounded-full overflow-hidden", children: _jsx("div", { className: `h-full rounded-full ${colors.bg}`, style: { width: `${progress}%` } }) }) }), _jsxs("div", { className: "ml-2 flex items-center", children: [progress >= 100 ? (_jsx(Award, { size: 14, className: "text-yellow-500 mr-1" })) : null, _jsxs("span", { className: `text-xs font-medium ${progress >= 100 ? 'text-yellow-600' : 'text-gray-500'}`, children: [Math.round(progress), "%"] })] })] })] })] }, metric.id));
                    }) })] }) }));
};
