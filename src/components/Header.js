...
export default function Header() {
    ...
    return (_jsxs("header", { className: "fixed w-full bg-white shadow z-50 font-Montserrat", children: [_jsx("div", { className: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: _jsxs("div", { className: "flex items-center justify-center h-24", children: [_jsx("div", { className: "absolute left-4 flex-shrink-0", children: _jsx(Logo, {}) }), _jsxs("nav", { className: "hidden md:flex space-x-8", children: [_jsx(Link, { to: "/", onClick: (e) => {
                                ...
                                e.preventDefault();
                                scrollToSection("services");
                            }, className: "block text-lg font-semibold text-black hover:text-primary transition", children: "Services" }), _jsx("a", { href: "https://blog.thelab210.com", target: "_blank", rel: "noopener noreferrer", className: "block text-lg font-semibold text-black hover:text-primary transition", children: "Blog" }), _jsx("button", { onClick: () => scrollToSection("appointment"), className: "block w-full bg-primary text-white px-4 py-2 rounded-md hover:bg-primary-dark text-center text-sm", children: "Begin Your Journey" })] }) }))] }));
}
